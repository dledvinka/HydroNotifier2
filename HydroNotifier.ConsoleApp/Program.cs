...
internal class Program
{
    ...
    private static async Task TestWebScraper()
    {
        ...
        hydroData.Add(await new WebScraper(HydroGuardQueries.LomnaQuery, driver, logMock.Object).GetLatestValuesAsync());
        hydroData.Add(await new WebScraper(HydroGuardQueries.OlseQuery, driver, logMock.Object).GetLatestValuesAsync());
        driver.Quit();
    }
